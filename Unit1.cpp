...
void __fastcall TForm1::TekstChange(TObject *Sender)
{
   ...
   if(OpenDialog1->Execute())
    {
      ...
      {
        ShowMessage("Bl¹d otwarcia pliku. Upewnij siê, ¿e plik istniejhe na dysku");
      }
...
void __fastcall TForm1::Nowy1Click(TObject *Sender)
{
    ...
    "Cz na pewno utworzyc nowy plik?","PotwierdŸ",
...
{
    if(Application->MessageBox(
    "Cz na pewno zakonczyc program?","PotwierdŸ",
...
void __fastcall TForm1::Oprogrmaie1Click(TObject *Sender)
{
    Form2->ShowModal();
...
void __fastcall TForm1::LInkdostrony1Click(TObject *Sender)
{
   ShellExecute(NULL,"open", "http://damian-cwykiel-landingpage-co-uk.stackstaging.com/#projects",
